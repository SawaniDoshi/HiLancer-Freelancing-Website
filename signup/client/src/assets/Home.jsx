        ...
        <nav className="container-main">
          <div className="navbar-content">
              ...
              <a tabIndex="0" aria-live="assertive" className="ButtonElement" href="/" target="_self">
                <fl-logo>
                  <picture>
                    <div className="logo">
                      <img
                        src="https://img.freepik.com/free-photo/view-3d-woman-using-laptop_23-2150710074.jpg?t=st=1727536797~exp=1727540397~hmac=ac3086ec1dc3cca4a6f4eb2c9fc00fd18e4aeba481182750de138357ae0c7977&w=690"
                        alt=""
            ...
            <div className="nav-links">
              <a href="/register">Hire Experts</a>
              <a href="/register">Get Hired</a>
          ...
          <div className="font-bold flex gap-4">
            <a href="/login" className="text-white text-xxl pr-2 ">Login</a>
